...
generatedTextAssets.set(
  path.join(zenxRoot, "src", "main", "startup-brand.ts"),
  "// Generated by scripts/generate-brand-assets.mjs.\n// prettier-ignore\nexport const startupBrand = " +
    JSON.stringify(
      canonicalSvg({
        id: "zenx-startup-title",
        title: "ZenX",
        viewBox: "0 0 400 80",
        content: `<g transform="translate(8 8)">${markContent}</g><g transform="translate(96 8)">${wordmarkContent}</g>`,
      }),
    ) +
    ";\n",
);
