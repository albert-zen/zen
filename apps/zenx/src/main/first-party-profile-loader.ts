...
export const FIRST_PARTY_PLUGIN_PACKAGES = Object.freeze({
  ...
  browser: {
    ...
    tarball: "zenx-browser-plugin-electron-1.0.2.tgz",
  },
  computer: {
    pluginId: "computer",
...
export function firstPartyProviderTarball(
  ...
  if (pluginId === "browser") {
    if (providerId === "electron-dedicated-browser")
      return "zenx-browser-plugin-electron-1.0.2.tgz";
    if (providerId === "playwright-cli")
      return "zenx-browser-plugin-playwright-1.0.2.tgz";
    if (providerId === "user-browser-cdp")
      return "zenx-browser-plugin-user-session-1.0.2.tgz";
  }
