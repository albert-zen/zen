...
Use these paths for Canvas-driven agent workflow artifacts in this repo.

| Artifact | Path |
| --- | --- |
| Architecture Canvas Markdown | `docs/architecture.md` |
| Design intent | `docs/design-intent.md` |
