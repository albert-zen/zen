...
| --- | --- | --- | --- | --- | --- | --- | --- |
| 003<br>004<br>005<br>006<br>007 | 001 | - | 002 | - | - | - | - |
...
| long-term-optimization-002 | Agent Review | none | `codex/long-term-optimization-002` | 1 | 0 | `docs/implementation/long-term-optimization-002-evidence.md` |
...
- [ ] Wave 1: 001 and 002 implemented in parallel and each strict review loop
      passes.
- [ ] Wave 1: 001 and 002 integrated, then full current gates pass.
