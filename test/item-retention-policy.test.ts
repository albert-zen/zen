...
describe("ItemRetentionPolicy", () => {
  ...
  it("treats delta and progress items as extended retention candidates", () => {
    ...
    expect(
      deltasAndProgress.map((candidate) =>
        policy.shouldRetain(candidate, { mode: "extended" })
      )
